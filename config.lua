...
--Script Stuff--
Config.Delays = {
	WeedProcessing = 15000 * 10,
	CocaineProcessing = 20000 * 10,
	EphedrineProcessing = 25000 * 10,
	MethProcessing = 24000 * 10,
	PoppyProcessing = 26000 * 10,
	CrackProcessing = 21000 * 10,
	HeroineProcessing = 19000 * 10
}

Config.FieldZones = {
	WeedField = {coords = vector3(2224.2, 5566.53, 54.06), name = 'WeedField', color = 1, sprite = 496, radius = 1.0},
	CocaineField = {coords = vector3(1849.8, 4914.2, 44.92), name = 'CocaineField', color = 2, sprite = 496, radius = 1.0},
	EphedrineField = {coords = vector3(1591.18, -1982.81, 95.12), name = 'EphedrineField', color = 3, sprite = 496, radius = 1.0},
	PoppyField = {coords = vector3(-1800.83, 1990.43, 132.71), name = 'PoppyFieldh', color = 5, sprite = 496, radius = 1.0},
}

Config.ProcessZones = {
	WeedProcessing = {coords = vector3(2329.02, 2571.29, 46.68), name = 'WeedProcessing', color = 25, sprite = 496, radius = 1.0},
	CocaineProcessing = {coords = vector3(-2083.58, -1011.96, 5.88), name = 'CocaineProcessing', color = 4, sprite = 455, radius = 1.0},
	EphedrineProcessing = {coords = vector3(-1078.62, -1679.62, 4.58), name = 'EphedrineProcessing', color = 62, sprite = 310, radius = 1.0},
	MethProcessing = {coords = vector3(1391.94, 3605.94, 38.94), name = 'MethProcessing', color = 25, sprite = 93, radius = 1.0},
	CrackProcessing = {coords = vector3(974.72, -100.91, 74.87), name = 'CrackProcessing', color = 72, sprite = 226, radius = 1.0},
	PoppyProcessing ={coords = vector3(3559.76, 3674.54, 28.12), name = 'PoppyProcessing', color = 38, sprite = 499, radius = 1.0},
	HeroineProcessing = {coords = vector3(1976.76, 3819.58, 33.45), name = 'HeroineProcessing', color = 59, sprite = 388, radius = 1.0},
}
